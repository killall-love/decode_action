//Tue Oct 28 2025 00:13:19 GMT+0000 (Coordinated Universal Time)
...
function artworkShort2Long(_0x5b9001) {
  var _0x3967c1;
  const _0x33dd82 = (_0x3967c1 = _0x5b9001 === null || _0x5b9001 === undefined ? undefined : _0x5b9001.indexOf("/")) !== null && _0x3967c1 !== undefined ? _0x3967c1 : -1;
...
function formatAlbumItem(_0x15641b) {
  ...
  return {
    ...
    "artwork": (_0x523ec2 = _0x15641b.img) !== null && _0x523ec2 !== undefined ? _0x523ec2 : artworkShort2Long(_0x15641b.pic),
...
async function getAlbumInfo(_0x50b76d) {
  const _0x17ab05 = (await (0, axios_1.default)({
    ...
    _0x491abb = _0x17ab05.musiclist.map(_0x3e036a => {
      ...
      return {
        "id": _0x3e036a.id,
        "artwork": (_0x4d3ae2 = _0x50b76d.artwork) !== null && _0x4d3ae2 !== undefined ? _0x4d3ae2 : _0x17ab05.img,
    ...
    "data": _0x6b3ae3.child.map(_0x2e8ec4 => {
      {
        ...
        return {
          ...
          "coverImg": (_0x16aba2 = (_0x3eae88 = _0x2e8ec4.pic5) !== null && _0x3eae88 !== undefined ? _0x3eae88 : _0x2e8ec4.pic2) !== null && _0x16aba2 !== undefined ? _0x16aba2 : _0x2e8ec4.pic,
...
async function importMusicSheet(_0x227a42) {
  ...
  let _0x573fe8;
  if (!_0x573fe8) {
    _0x573fe8 = (_0x3489cb = _0x227a42.match(/https?:\/\/www\/kuwo\.cn\/playlist_detail\/(\d+)/)) === null || _0x3489cb === undefined ? undefined : _0x3489cb[1];
  }
  !_0x573fe8 && (_0x573fe8 = (_0x4c58e2 = _0x227a42.match(/https?:\/\/m\.kuwo\.cn\/h5app\/playlist\/(\d+)/)) === null || _0x4c58e2 === undefined ? undefined : _0x4c58e2[1]);
  if (!_0x573fe8) {
...
module.exports = {
  ...
  "hints": {
    "importMusicSheet": ["酷我APP：自建歌单-分享-复制试听链接，直接粘贴即可", "H5ï¼šå¤åˆ¶URLå¹¶ç²˜è´´ï¼Œæˆ–è€…ç›´æŽ¥è¾“å…¥çº¯æ•°å­—æ­Œå•IDå³å¯", "å¯¼å…¥æ—¶é—´å’Œæ­Œå•å¤§å°æœ‰å…³ï¼Œè¯·è€å¿ƒç­‰å¾…"]
  },
